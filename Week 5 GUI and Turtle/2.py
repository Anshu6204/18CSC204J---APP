...
Label(master, text= 'Personal Information',fg='brown').place(x=5,y= 5+ 10)
...
Label(master,text='PREVIOUS/CURRENT EMPLOYMENT DETAILS',fg='brown').place(x=5+0,y= 25+ 15+350)
...
Label(master, text='REFERENCE #1',fg='brown').place(x=5+0,y= 25+ 15+470)
Label(master, text='Name ').place(x=5+0,y= 25+ 15+490) 
Label(master, text='Phone ').place(x=5+0,y= 25+ 15+530)
Label(master, text='REFERENCE #2 ',fg='brown').place(x=5+0,y= 25+ 15+550)
...
btn = Button(master, text='Apply',bg='brown',fg='white').place(x=5+160,y= 25+ 15+650)
master.mainloop()